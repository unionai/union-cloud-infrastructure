...
READER_POLICY_DOCUMENT = PolicyDocument(
    Version="2012-10-17",
    Statement=[
        Statement(
...
MANAGER_POLICY_DOCUMENT = PolicyDocument(
        Version="2012-10-17",
        Statement=[
            Statement(
...
PROVISIONER_POLICY_DOCUMENT = PolicyDocument(
        Version="2012-10-17",
        Statement=[
            Statement(
...
ADMIN_POLICY_DOCUMENT = PolicyDocument(
        Version="2012-10-17",
        Statement=[
            Statement(
                Effect=Allow,
...
def create_read_policy(role_type):
    ...
    return ManagedPolicy(
        ...
        PolicyDocument=READER_POLICY_DOCUMENT,
    )
...
def create_manager_policy(role_type):
    ...
    return ManagedPolicy(
        ...
        PolicyDocument=MANAGER_POLICY_DOCUMENT,
    )
...
def create_provisioner_policy(role_type):
    ...
    return ManagedPolicy(
        ...
        PolicyDocument=PROVISIONER_POLICY_DOCUMENT,
    )
...
def main():
    ...
    with open(os.path.join(parent_dir, f"terraform", "reader-policy.yaml"), "w") as file:
        file.write(READER_POLICY_DOCUMENT.to_json())

    with open(os.path.join(parent_dir, f"terraform", "manager-policy.yaml"), "w") as file:
        file.write(MANAGER_POLICY_DOCUMENT.to_json())

    with open(os.path.join(parent_dir, f"terraform", "provisioner-policy.yaml"), "w") as file:
        file.write(PROVISIONER_POLICY_DOCUMENT.to_json())

    with open(os.path.join(parent_dir, f"terraform", "admin-policy.yaml"), "w") as file:
        file.write(READER_POLICY_DOCUMENT.to_json())
